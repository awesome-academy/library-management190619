...
ActiveRecord::Schema.define(version: 2019_06_19_061621) do
  ...
  create_table "followings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["book_id"], name: "index_followings_on_book_id"
  ...
  add_foreign_key "followings", "authors"
  add_foreign_key "followings", "books"
